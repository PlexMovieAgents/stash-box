...
func TestCopyFromPerformerEdit(t *testing.T) {
	input := PerformerEdit{
		...
		Height:            &bHeight64,
		CupSizeUS:         &bCupSize,
		BandSizeUS:        &bBandSize64,
		WaistSizeUS:       &bWaistSize64,
		HipSizeUS:         &bHipSize64,
	...
	old := PerformerEdit{
		...
		Height:            &aHeight64,
		CupSizeUS:         &aCupSize,
		BandSizeUS:        &aBandSize64,
		WaistSizeUS:       &aWaistSize64,
		HipSizeUS:         &aHipSize64,
	...
	orig := Performer{
		...
		CupSizeUS:         sql.NullString{String: aCupSize, Valid: true},
		BandSizeUS:        sql.NullInt64{Int64: int64(aBandSize), Valid: true},
		WaistSizeUS:       sql.NullInt64{Int64: int64(aWaistSize), Valid: true},
		HipSizeUS:         sql.NullInt64{Int64: int64(aHipSize), Valid: true},
	...
	assert.DeepEqual(t, Performer{
		...
		CupSizeUS:         sql.NullString{String: bCupSize, Valid: true},
		BandSizeUS:        sql.NullInt64{Int64: int64(bBandSize), Valid: true},
		WaistSizeUS:       sql.NullInt64{Int64: int64(bWaistSize), Valid: true},
		HipSizeUS:         sql.NullInt64{Int64: int64(bHipSize), Valid: true},
